...
public:
    ...
    PlayerController(uintptr_t pawn, int idx, EntityType type, int mHealth, bool mVisible, bool mHasGunImmunity,
                     const Vector3 &mCurrentPos, uintptr_t mBoneArray, int mCurrentTeam, std::string mPlayerName,
